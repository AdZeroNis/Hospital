                ...
                <form method="POST" action="{{ route('Panel.UpdateSurgery', $surgery->id) }}">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="description" name="description">{{ $surgery->description }}</textarea>
                        </div>
                        <div class="mb-3">
                            <label for="surgeried_at" class="form-label">تاریخ عمل جراحی</label>
                            <input type="date" class="form-control" id="surgeried_at" name="surgeried_at" value="{{ $surgery->surgeried_at }}" required>
                        </div>
                        <div class="mb-3">
                            <label for="released_at" class="form-label">تاریخ ترخیص</label>
                            <input type="date" class="form-control" id="released_at" name="released_at" value="{{ $surgery->released_at }}" required>
                        </div>
                    </div>
