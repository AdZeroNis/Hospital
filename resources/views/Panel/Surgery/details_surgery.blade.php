                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row g-2">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="border-bottom pb-1">{{ \Morilog\Jalali\Jalalian::fromDateTime($surgery->surgeried_at)->format('Y/m/d') }}</div>
                                        </div>
                                        <div class="col-12">
                                            <label class="form-label fw-bold text-primary">تاریخ ترخیص:</label>
                                            <div class="border-bottom pb-1">{{ \Morilog\Jalali\Jalalian::fromDateTime($surgery->released_at)->format('Y/m/d') }}</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-4">
                                    <div class="card h-100 border-primary">
                                        <div class="card-body">
                                            <h6 class="card-subtitle mb-2 text-muted">
                                                <i class="fas fa-user-md me-2"></i>مشاور
                                            </h6>
