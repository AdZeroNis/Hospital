...
class OperationController extends Controller
{
    public function index()
    {
        ...
        return view('Admin.Operation.operationList', compact('operations', 'user'));
    }

    public function create()
    {
        $user = Auth::user();
        return view('Admin.Operation.createOperation', compact('user'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('Admin.Operation.editOperation', compact('operation', 'user'));
    }
