...
class SurgeryController extends Controller
{
    public function index()
    {
        ...
        return view('Admin.Surgery.surgeryList', compact('surgeries', 'user'));
    }
    ...
    public function create()
    {
        ...
        return view('Admin.Surgery.createSurgery', compact('user', 'insurances', 'doctors', 'operations', 'doctor_roles'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('Admin.Surgery.editSurgery', compact('surgery', 'user', 'insurances', 'doctors', 'operations', 'surgeried_at', 'released_at'));
    }
    ...
    public function filters(Request $request)
    {
        ...
        return view('Admin.Surgery.surgeryList', [
            'surgeries' => $surgeries,
    ...
    public function details($id)
    {
        ...
        return view('Admin.Surgery.details_surgery', compact('surgery', 'user', 'doctorsInfo'));
    }
}
