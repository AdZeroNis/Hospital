...
class DoctorRoleController extends Controller
{
    ...
    {
        $user = Auth::user();
        $roles = DoctorRole::latest()->get();
        return view('Admin.RoleDoctor.roleDoctorList', compact('roles', 'user'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('Admin.RoleDoctor.editRoleDoctor', compact('role', 'user'));
    }
    ...
    public function filters(Request $request)
    {
        ...
        return view('Admin.RoleDoctor.roleDoctorList', [
            'roles' => $roles,
