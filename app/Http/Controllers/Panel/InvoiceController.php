...
class InvoiceController extends Controller
{
    public function index()
    {
        ...
        return view('Panel.Invoice.invoice-list', compact('invoices', 'user'));
    }
    ...
    public function pay()
    {
        ...
        return view('Panel.Invoice.invoice-pay', compact('user', 'doctors'));
    }
    ...
    public function searchPay(Request $request)
    {
        ...
        if ($request->has('doctor_id') && $request->doctor_id) {
            ...
            return view('Panel.Invoice.invoice-pay', compact('doctor', 'user', 'surgeries', 'doctors', 'showSurgeryList', 'totalAmount'));
        }
    ...
    {
        $user = Auth::user();
        $invoices = Invoice::with(['doctor', 'payments'])->get();
    ...
    public function print($id)
    {
        ...
        return view('Panel.Invoice.invoice', compact(
            'invoice',
            'surgeryDetails',
            'totalAmount',
            'paidAmount',
    ...
    public function filters(Request $request)
    {
        ...
        return view('Panel.Invoice.invoice-list', [
            'invoices' => $invoices,
